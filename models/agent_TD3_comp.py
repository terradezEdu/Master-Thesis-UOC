...
# Global variables
PATH_TENSORDBOARD= '/content/drive/MyDrive/TFM/TENSORDBOARD/TD3_exp'
VIDEO_PATH= '/content/drive/MyDrive/TFM/Video/TD3_exp/'
            ...
            while done == False:
                ...
                if done:                   
                    ...
                    if episode % save_episode == 0:
                        ...
                        df_rewards.to_csv('/content/drive/MyDrive/TFM/models/save/TD3/df_rewards_td3_exp' + '_'+ str(episode_start) + '.csv', index=False)
                        df_loss.to_csv('/content/drive/MyDrive/TFM/models/save/TD3/df_loss_td3_exp' + '_'+ str(episode_start) + '.csv', index=False)
